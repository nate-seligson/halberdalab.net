...
function generateNewMovie(fileID) {
	...
	if (imageData4) {
		...
		$.post("processVideo.php", { "fileID": fileID, "delay": ($('#cbShowPopMean').is(':checked') ? "12" : "10"), "imageData": imageData1, "chainId": chainId, "skipGif": "1" }).complete(function() {
		...
		// they can be pipelined to some degree, with the assumption that data1 will finish processing before data2 + data3... - this is not yet implemented.
			$.post("processVideo.php", { "fileID": fileID, "delay": ($('#cbShowPopMean').is(':checked') ? "12" : "10"), "imageData": imageData2, "chainId": chainId, "offset": imageArray2Offset, "skipGif": "1" }).complete(function() {
				$.post("processVideo.php", { "fileID": fileID, "delay": ($('#cbShowPopMean').is(':checked') ? "12" : "10"), "imageData": imageData3, "chainId": chainId, "offset": imageArray3Offset, "skipGif": "1" }).complete(function() {
					$.post("processVideo.php", { "fileID": fileID, "delay": ($('#cbShowPopMean').is(':checked') ? "12" : "10"), "imageData": imageData4, "chainId": chainId, "offset": imageArray4Offset, "skipGif": "1" }).complete(function() {
						$.post("processVideo.php", { "fileID": fileID, "delay": ($('#cbShowPopMean').is(':checked') ? "12" : "10"), "imageData": imageData5, "chainId": chainId, "offset": imageArray5Offset }).complete(function() {
							$.get('retrieveMovie.php?checkExists=1&fileID=' + fileID, function(response) {
