function [similarityMatrix,simMatAvgs,colorMat] = SimilarityMatrixCM(plot)
d = load('LikertRawData.mat');
colors = load('ColorWheel360.mat');
...
for j=1:length(colorBins)-1
    ...
    %cm
    %similarityMatrix(j,:) = interp1(colorBins,simAvg,-179:180,'spline');
...
if plot == 1
    ...
    %     colorMat2(jj,1,1:3) = colors.fullcolormatrix(whichColor2,:)./255;
    %   end
    %
