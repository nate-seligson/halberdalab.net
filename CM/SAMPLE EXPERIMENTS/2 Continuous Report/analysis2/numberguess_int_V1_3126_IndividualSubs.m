...
%intd = importdata('mostTargetSizeCM.csv');
 intd66= table2array(subjectStructNM3126.(subjID(ii)).nonGuessTrials66);
 
  intd66Transformed = table2array(subjectStructNM3126.(subjID(ii)).nonGuessTrials66Transformed);
...
scatter(intAns, intRespTransformed);
Marisize(12,1)
xlim([0,360]);
Marisize(12,1)
hold on;
