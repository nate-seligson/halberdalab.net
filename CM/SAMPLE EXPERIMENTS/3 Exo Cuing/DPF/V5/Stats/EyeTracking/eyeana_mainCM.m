function [allData,thisData]=eyeana_mainCM(sub,scr,const,eyeana,allData)
% ----------------------------------------------------------------------
...
% coordIncor  = [];
% 
% for t = 1:(size(tab,1)) %for all trials 
% 
%     % Variables
%     exo_cue    = resMat(t, 9);   % Rand 6  saccade target cue (2=left, 0=neutral, 1=right)
...
%     
% %     if eyeOK == 1 && exo_cue ~= 0 % saccade trial
% %         try
% %             tarPos = [const.posMat(exo_cue,1),const.posMat(exo_cue,2)];
% %         catch
