function [allDataTable,const,scr] = all_analysisCM2(subIni,domEye,expName,taskType,nbBlocks,eyeAnalysis)
% ----------------------------------------------------------------------
...
if eyeAnalysis
    ...
    for rep = sub.nbBlocks
        ...
        eyeana_mainCM2(sub,scr,const,eyeana);
%         if sub.block == 1
%             [allData,thisData] = eyeana_mainCM2(sub,scr,const,eyeana);
%         elseif sub.block > 1
%             [allData,thisData] = eyeana_mainCM2(sub,scr,const,eyeana,allData);
%         else
%             
%         end
