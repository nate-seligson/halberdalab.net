...
cd(fDir); cd('../../');
allExpDir = cd;
addpath(genpath(allExpDir));

try
   Screen('Preference', 'SkipSyncTests', 1);
   screen=max(Screen('Screens')); % screen=0; NMH 2020_04
   %AutoBrightness(screen,0);                                               % NMH 2020_04
   %Screen('ConfigureDisplay','Brightness',screen,[],1);                    % NMH 2020_04
   if 1
