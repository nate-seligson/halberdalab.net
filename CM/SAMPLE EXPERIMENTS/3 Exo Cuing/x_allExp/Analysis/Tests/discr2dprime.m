function dprime = discr2dprime(allDat,currDat)
% ----------------------------------------------------------------------
% dprime = discr2dprime(pVal,testVal,respVal)
% ----------------------------------------------------------------------
% Goal of the function :
% Compute dprime for a 2+AFC discrimination task using Signal Detection 
% Theory principle (dprime = Hit-FA)
% ----------------------------------------------------------------------
% Input(s) :
