...
jsPsych.plugins['visual-search-circleCM2'] = (function() {
    ...
    plugin.info = {
        ...
        parameters: {
            ...
            feedback_image: {
                ...
                default: 'img/feedbackImage.png',
                description: 'Path to image file that is a feedback circle.'
            },
    

            feedback_image_text_TP_CORRECT: {
                type: jsPsych.plugins.parameterType.IMAGE,
                pretty_name: 'feedback image text',
                default: 'img/feedbackImageTextCorrectTargetPresent.png',
                description: 'Path to image file that is a feedback text to display.'
            },
            feedback_image_text_TP_INCORRECT: {
                type: jsPsych.plugins.parameterType.IMAGE,
                pretty_name: 'feedback image text- incorrect',
                default: 'img/feedbackImageTextWrongTargetPresent.png',
                description: 'Path to image file that is a feedback text to display on wrong trials.'
            },

            feedback_image_text_TA_INCORRECT: {
                type: jsPsych.plugins.parameterType.IMAGE,
                pretty_name: 'feedback image text- incorrect',
                default: 'img/feedbackImageTextWrongTargetAbsent.png',
                description: 'Path to image file that is a feedback text to display on wrong trials.'
            },

            feedback_image_text_TA_CORRECT: {
                type: jsPsych.plugins.parameterType.IMAGE,
                pretty_name: 'feedback image text- TA Correct',
                default: 'img/feedbackImageTextCorrectTargetAbsent.png',
                description: 'Path to image file that is a feedback text to display on wrong trials.'
            },
            ...
            feedback_text_size: {
                ...
                pretty_name: 'feedback text size',
                array: true,
                default: [750, 750],
            ...
            feedback: {
                type: jsPsych.plugins.parameterType.BOOL,
                pretty_name: 'Want feedback?',
                default: true,
                description: 'Want feedback?'
            },
    ...
    plugin.trial = function(display_element, trial) {
        ...
        var feedbackCircle =  trial.feedback_image;
        var feedback_text_size = trial.feedback_text_size;
        ...
        var feedback_loc = [Math.floor(paper_size / 2 - trial.feedback_text_size[0] / 2), Math.floor(paper_size / 2 - trial.feedback_text_size[1] / 2)];
        ...
        function show_search_array() {
            ...
            (jsPsych.pluginAPI.compareKeys(info.key, trial.target_absent_key)) && !trial.target_present) {
                ...
                function showFeedback() {
                    if (trial.feedback == true && correct != true && trial.target_present == true) {
                    // if the target is present and they're incorrect: 
                        paper.innerHTML += '<img src=\''+feedbackCircle+'\' style=\'position: absolute; top:'+display_locs[0][0]+'px; left:'+display_locs[0][1]+'px; width:'+trial.target_size[0]+'px; height:'+trial.target_size[1]+'px;\'></img>';
                        paper.innerHTML += '<img src=\''+trial.feedback_image_text_TP_INCORRECT+'\' style=\'position: absolute; top:'+feedback_loc[0]+'px; left:'+feedback_loc[1]+'px; width:'+feedback_text_size[0]+'px; height:'+feedback_text_size[1]+'px;\'></img>';
                    
                    
                    } else if (trial.feedback == true && correct == true && trial.target_present == true) {
                    // if the target is present and they're correct: 
                        paper.innerHTML += '<img src=\''+feedbackCircle+'\' style=\'position: absolute; top:'+display_locs[0][0]+'px; left:'+display_locs[0][1]+'px; width:'+trial.target_size[0]+'px; height:'+trial.target_size[1]+'px;\'></img>';
                        paper.innerHTML += '<img src=\''+trial.feedback_image_text_TP_CORRECT+'\' style=\'position: absolute; top:'+feedback_loc[0]+'px; left:'+feedback_loc[1]+'px; width:'+feedback_text_size[0]+'px; height:'+feedback_text_size[1]+'px;\'></img>';
                   
                    } else if (trial.feedback == true && correct != true && trial.target_present == false) {
                        // if the target is absent and they're incorrect:
                        paper.innerHTML += '<img src=\''+trial.feedback_image_text_TA_INCORRECT+'\' style=\'position: absolute; top:'+feedback_loc[0]+'px; left:'+feedback_loc[1]+'px; width:'+feedback_text_size[0]+'px; height:'+feedback_text_size[1]+'px;\'></img>';
                       
                    } else if (trial.feedback == true && correct == true && trial.target_present == false) {
                        // if the target is absent and they're correct: 
                        paper.innerHTML += '<img src=\''+trial.feedback_image_text_TA_CORRECT+'\' style=\'position: absolute; top:'+feedback_loc[0]+'px; left:'+feedback_loc[1]+'px; width:'+feedback_text_size[0]+'px; height:'+feedback_text_size[1]+'px;\'></img>';
                    } 
