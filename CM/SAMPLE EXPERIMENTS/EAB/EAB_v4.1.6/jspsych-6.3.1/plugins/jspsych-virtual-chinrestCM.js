 ...
 *  virtual chinrest plugin for jsPsych, based on Qisheng Li 11/2019. /// https://github.com/QishengLi/virtual_chinrest
    ...
    CM Edited so square is now white. 
 */
...
jsPsych.plugins["virtual-chinrest"] = (function () {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      blindspot_prompt: {
        ...
        default: `
          <p>Thanks! Now we will quickly measure how far away you are sitting.</p>
          <div style="text-align: left">
            <ol>
              <li>Put your left hand on the <b>space bar</b>.</li>
              <li>Cover your right eye with your right hand.</li>
              <li>Using your left eye, focus on the white square. Keep your focus on the white square.</li>
  ...
  plugin.trial = function (display_element, trial) {
    ...
    function drawBall(pos = 180) {
      ...
      window.ball = ball;
      // make it white:
      var square = mySVG.rect(30, 30).move(Math.min(rectX - 50, 950), 50).fill("#FFFFFF"); //square position
