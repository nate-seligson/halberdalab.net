...
jsPsych.plugins['continuous-line6'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-line6',
        description: '',
        parameters: {
            set_size: {
    ...
    document.getElementById('reportDiv').innerHTML = html;
       ...
       left:  ${curLeftCenter}px;
        ...
        left: ${curLeft}px; 
                ...
                width: ${wheel_radius*4}px;
                height: ${wheel_radius*4}px'>&nbsp;
        </div>`;
       ...
       document.getElementById('contMemoryFixation').innerHTML = html;
        ...
        var getResponse = function() {
            ...
            if (trial.which_test==-1) {
                ...
                SetMask('maskItem'+pos[0],trial,trial.respCirc, trial,0);
