...
jsPsych.plugins['continuous-face3'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-face3',
        description: '',
        parameters: {
            set_size: {
...
' " style = "transform: rotate( ' + (1) + 'deg); top:' + (curTopCenter) + 'px; left:' + (curLeftCenter) + 
'px; border-radius: 50%; width:' + 200 + 'px; height: ' + 200 + 'px;"/>' + '</div>';
 ...
 var mouseclickevent = function() {
                ...
                var trial_data = {
                   // "fix_duration": start_time - fixstart,
                    ...
                    'whichFace': arrow_rotation[0][0],
                    'orientation_of_target': arrow_rotation[0][0],
                    'allFaces': arrow_rotation,
...
- trial.item_size/2 + center;
      ...
      var width = trial.radius * 2 + trial.item_size * 2 + 50;
       ...
       var myImg = 'img/export' + rotdegrees + '.png';
