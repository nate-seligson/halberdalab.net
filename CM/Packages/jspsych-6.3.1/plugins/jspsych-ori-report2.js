...
jsPsych.plugins['ori-report2'] = (function() {
...
//change the below line if you want live readout: 
            html = '<img src="' + gaborgen(targetOriText, 20) + 
...
//709 should be set to noBar_wheel
       ...
       document.getElementById('contMemoryFixation').innerHTML = html;
        ...
        var updateAngle = function(e) {
            ...
            var param = Math.abs((param - 360)); // This is to reverse the rotation, so it matches our stimulus. 
 ...
 var mouseclickevent = function() {
               ...
               //var final_angle = Math.abs((param - 360));
