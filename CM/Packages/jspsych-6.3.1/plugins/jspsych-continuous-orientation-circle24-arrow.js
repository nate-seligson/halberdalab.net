...
jsPsych.plugins['continuous-orientation-circle24-arrow'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle24-arrow',
        description: '',
        parameters: {
            set_size: {
...
//<img src="your image" style="transform:rotate(90deg);">
            ...
            ' " style = "transform: rotate( ' + (sceneNum) + 'deg); top:' + (curTopCenter) + 'px; left:' + (curLeftCenter) + 
