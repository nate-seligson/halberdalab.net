...
jsPsych.plugins['color-model'] = (function() {
    ...
    plugin.info = {
        ...
        parameters: {
            ...
            //    default: 80,
            //    description: 'radius of each circle in pixels.'
            //},
    ...
    plugin.trial = function(display_element, trial) {
     ...
     --------------------------------*/
       ...
       #contMemoryBox {
        ...
        var maskwidth = trial.radius * 2 + trial.mask_size * 2 + 50;
        var maskheight = trial.radius * 2 + trial.mask_size * 2 + 50;
        var maskcenter = width/2;
        ...
        var startTrial = function() {
           ...
           // display_element.querySelector('#contMemoryFixation').addEventListener('click', document.getElementById('nocursor').style.cursor = 'none');
     ...
     -------------------------------- */ 
        ...
        ////////////////////////////////// NOW MASK: ///////////////////////////////////////////
        var pos = jsPsych.randomization.sampleWithoutReplacement(possiblePositions2, trial.set_size);
        if (trial.item_positions.length>0) {
            pos = trial.item_positions;
        }
