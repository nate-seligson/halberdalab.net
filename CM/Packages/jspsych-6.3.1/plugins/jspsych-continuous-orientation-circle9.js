...
jsPsych.plugins['continuous-orientation-circle9'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle9',
        description: '',
        parameters: {
            set_size: {
        ...
        rgb(200, 5, 5); top: ${topPx}px; left: ${leftPx}px;'></div>`;   */
          ...
          // document.getElementById('reportDiv').src = handleCM
           ...
           var image = document.getElementsByClassName("contMemoryBox");
            ...
            html = "<div id='" + 'contMemoryBox' + "'>" + 
           
            '<img src="' + gaborgen(360 - sceneNum, 10) + '"/>' + '</div>';
