...
jsPsych.plugins['continuous-orientation-circle16'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle16',
        description: '',
        parameters: {
            set_size: {
       ...
       #contMemoryBox {
        ...
        for (var i=0; i < trial.num_placeholders; i++) {
            ...
            let curLeft = (Math.sin((Math.PI*2)/(trial.num_placeholders)*i)*trial.radius)
                 ...
                 var myImg = gaborgen(5, 4) //UNCOMMENT FOR REAL ONE
        
            html += `<div id="maskitem${i}gab${j}" class="contMemoryItem" 
                 style="top:${curTop + getRandomIntInclusive(-30,30)}px; transform: rotate(${trial.mask_rotation[0][i]}deg); left:${curLeft + getRandomIntInclusive(-30,30)}px; 
...
//////FIRST ONE
    ...
    function SetMask(id, deg, myImg, trial,rotdegrees) {
       ...
       document.getElementById(id).style.backgroundSize = 'contain';
        ...
        document.getElementById(id).innerHTML +=   '<img src="' + gaborgen(2, 5) + 
        '" style = "top:' + (curTopCenter) + 'px; left:' + (curLeftCenter) + 
        'px; border-radius: 50%; width:' + trial.item_size + 'px; height: ' + trial.item_size + 'px;"/>' + '</div>';

      // 'style= "position: relative;"></div>';

       //html +=  '<img src="' + gaborgen(45, 20) + 
     //  '" style = "top:' + (curTopCenter + 10) + 'px; left:' + (curLeftCenter + 10) + 
     //  'px; border-radius: 50%; width:' + trial.item_size + 'px; height: ' + trial.item_size + 'px;"/>' + '</div>';
     // 'style= "position: absolute;"></div>';
       
//document.getElementById(id).innerHTML = html;
//document.getElementById(id).style.backgroundSize="48px, contain";
