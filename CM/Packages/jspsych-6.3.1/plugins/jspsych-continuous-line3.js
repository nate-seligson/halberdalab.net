...
jsPsych.plugins['continuous-line3'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-line3',
        description: '',
        parameters: {
            set_size: {
     ...
     -------------------------------- */ 
       ...
       // var param = 0;
        ...
        function draw(param) {
            ...
            if (param == 360) {
                var handle = 'materials/noBar_wheelCM.png';
               //CM = 'img/mybackground.png';
                var handleCM = 'img/noBar_wheelCM.png';
            } else {
                var handle = 'materials/handle_wheelCM.png';
             //   var handleCM = 'img/mybackground.png';
                var handleCM = 'img/handle_wheelCM.png';
            }
...
html = '<img src="img/line1'  + '.png' +
' " style = "top:' + (curTopCenter) + 'px; left:' + (curLeftCenter) + 
'px; border-radius: 50%; width:' + (sceneNum) + 'px; height: ' + 360 + 'px;"/>' + '</div>';
 ...
 */
 ...
 var mouseclickevent = function() {
    ...
    function SetItem(id, deg, myImg, trial,rotdegrees) {
        ...
        //document.getElementById(id).style.transform = 'rotate(' + 180 + 'deg)';
    ...
    function SetGaborOld(id, deg, myImg, trial,rotdegrees) {
        ...
        deg=(deg<0) ? deg+360:deg;
        var amt = rotdegrees;
        var myImg = gaborgen(360 - deg, trial.sf) 
        document.getElementById(id).style.backgroundImage = `url('${myImg.toString()}')`;
    }
    ...
    function SetGabor(id, deg, myImg, trial,length,line_ori) {
       ...
       // document.getElementById(id).style.backgroundSize = 'cover'; //contain
       //  var myImg = gaborgen(rotdegrees, trial.sf) 
        // document.getElementById(id).style.backgroundSize = 'contain';

        temp = 'img/line1'
        document.getElementById(id).style.backgroundImage = `url('${temp.toString()}.png')`;
       // document.getElementById(id).style.backgroundPosition = "absolute";
        ...
        document.getElementById(id).style.backgroundSize = length + 'px 360px';
