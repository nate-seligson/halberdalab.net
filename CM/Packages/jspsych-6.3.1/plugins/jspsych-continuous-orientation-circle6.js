...
jsPsych.plugins['continuous-orientation-circle6'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle6',
        description: '',
        parameters: {
            set_size: {
        ...
        function draw(param) {
           ...
           html += "<div id='" + 'backgroundRing' + "'>" +
            ...
            '<img src="' + gaborgen(360 - sceneNum, 10) + '"/>' +
                ...
                '<div id="' + 'contMemoryFixation' + '"><img src="' + handleCM + '"' +
              // 'style="width:30%; transform: rotate(' + (180) + 'deg)"></div>';
              'style="transform: rotate(' + (param + wsp) + 'deg)"></div>';
