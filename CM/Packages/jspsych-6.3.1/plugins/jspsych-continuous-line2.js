...
jsPsych.plugins['continuous-line2'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-line2',
        description: '',
        parameters: {
            set_size: {
       ...
       #contMemoryBox {
        ...
        for (var i=0; i < trial.num_placeholders; i++) {
            ...
            html += `<div id="item${i}" class="contMemoryItem"  
                 style="top:${curTop}px; left:${curLeft}px; border-radius: 50%; background-color: '';
        ...
        html += `<span id="contMemoryFixation" style="cursor: pointer">+</span>
         ...
         width:${trial.item_size}px; 
         height:${trial.item_size}px; background-color: '#DDDDDD';  "></div>
...
html = '<img src="img/line' + '.png' +
' " style = "top:' + (curTopCenter) + 'px; left:' + (curLeftCenter) + 
'px; border-radius: 50%; width:' + sceneNum + 'px; height: ' + 90 + 'px;"/>' + '</div>';
