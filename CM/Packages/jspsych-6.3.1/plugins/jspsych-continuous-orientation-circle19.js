...
jsPsych.plugins['continuous-orientation-circle19'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle19',
        description: '',
        parameters: {
            set_size: {
...
//this is the one we've been using
        ...
        var showMask = function(ms, callback) {
            if ( trial.mask_display_time > 0 ) {
                for (var i=0; i<trial.set_size; i++) {
                  ...
                  //  generateColorsMaxMin(setSizeInput,minDistance, maxRelDistance, MaxDistance)
 ...
 -------------------------------- */ 
     ...
     >= trial.mask_display_time - (last_mask_frame_duration/2)) { 
                ...
                for (var i=0; i<trial.set_size; i++) {
                    for (var j=0; j<trial.set_size; j++) {
