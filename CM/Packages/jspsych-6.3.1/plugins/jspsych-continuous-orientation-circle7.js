...
jsPsych.plugins['continuous-orientation-circle7'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle7',
        description: '',
        parameters: {
            set_size: {
 ...
 -------------------------------- */ 
     ...
     -------------------------------- */ 
        ...
        function draw(param) {
            ...
            //html = "<div id='" + 'contMemoryChoice' + "'>" +
            '<img src="' + gaborgen(360 - sceneNum, 10) + '"/>' +
              
                '<div id="' + 'contMemoryChoice' + '"><img src="' + handleCM + '"' +
              // 'style="width:30%; transform: rotate(' + (180) + 'deg)"></div>';
              'style="float: center; width:' + width +'px;  height: ' + height + 'px; transform: rotate(' + (param + wsp) + 'deg)"></div>';
