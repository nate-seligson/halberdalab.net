...
jsPsych.plugins['continuous-orientation-circle'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle',
        description: '',
        parameters: {
            set_size: {
     ...
     -------------------------------- */ 
        ...
        function draw(param) {
           ...
           // var param = trial.starting_value;
            var param = 0 ; //////CM WILL NEED TO CHANH=GE
