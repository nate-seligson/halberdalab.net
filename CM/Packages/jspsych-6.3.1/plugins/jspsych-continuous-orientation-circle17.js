...
jsPsych.plugins['continuous-orientation-circle17'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle17',
        description: '',
        parameters: {
            set_size: {
   ...
   //THIS WORKS
     ...
     //   '" style = "top:' + (curTopCenter) + 'px; left:' + (curLeftCenter) + 
       // 'px; border-radius: 50%; width:' + trial.item_size + 'px; height: ' + trial.item_size + 'px;"/>' + '</div>';
        ...
        '; border-radius: 50%; width:' + trial.item_size + 'px; height: ' + trial.item_size + 'px; position: absolute; justify-content: center"/>' + '</div>';
    }
