...
jsPsych.plugins['continuous-orientation-circle18'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle18',
        description: '',
        parameters: {
            set_size: {
        ...
        var showMask = function(ms, callback) {
            if ( trial.mask_display_time > 0 ) {
                for (var i=0; i<trial.set_size; i++) {
                    ...
                    SetMask('maskitem'+pos[i]+'gab'+[j],trial,trial.maskArray[0][i], trial,trial.mask_rotation[i][j]);
