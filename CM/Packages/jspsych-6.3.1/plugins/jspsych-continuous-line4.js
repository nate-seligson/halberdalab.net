...
jsPsych.plugins['continuous-line4'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-line4',
        description: '',
        parameters: {
            set_size: {
       ...
       document.getElementById('contMemoryFixation').innerHTML = html;
        ...
        //    var container_centerY = rect.top + rect.height / 2;
         ...
         //   var y = e.clientY - container_centerY;
          ...
          // draw(param); // refresh the display
        };
        ...
        var updateAngle = function(e) {
           ...
           // this works:
            ...
            //mouse_angle = Math.floor((y* 180 / Math.PI + 360) % 360); // in positive, integer, degree unit
           // if (mouse_angle > 200) {
           //     mouse_angle = 200
          //  } else if (mouse_angle < 20) {
          //      mouse_angle = 20
         //   }
