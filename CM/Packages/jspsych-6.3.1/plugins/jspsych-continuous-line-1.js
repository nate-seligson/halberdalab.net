...
jsPsych.plugins['continuous-line-1'] = (function() {
...
//<img src="your image" style="transform:rotate(90deg);">
            ...
            ' " style = "transform: rotate( ' + (0) + 'deg); top:' + (curTopCenter) + 'px; left:' + (curLeftCenter) + 
            'px; border-radius: 50%; width:' + ((sceneNum )) + 'px; height: ' + 200 + 'px;"/>' + '</div>';
 ...
 */
 ...
 var mouseclickevent = function() {
    ...
    function SetGaborGood(id, deg, myImg, trial,rotdegrees) {
        deg=(deg>=360) ? deg-360:deg;
        document.getElementById(id).style.backgroundImage = `url('${myImg.toString()}')`;
...
- trial.item_size/2 + center;
      ...
      var width = rotdegrees;
       ...
       // document.getElementById(id).style.backgroundSize = 'contain';
        document.getElementById(id).style.backgroundImage = `url('${myImg.toString()}')`;
        document.getElementById(id).style.borderRadius = rotdegrees; 
        //document.getElementById(id).style.top = curTopCenter; 
       // document.getElementById(id).style.left = curLeftCenter; 
        //document.getElementById(id).style.backgroundSize = 'contain';
        document.getElementById(id).style.width = rotdegrees; 
