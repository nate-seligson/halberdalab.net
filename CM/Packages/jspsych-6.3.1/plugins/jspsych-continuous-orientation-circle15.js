...
jsPsych.plugins['continuous-orientation-circle15'] = (function() {
 
    var plugin = {};

    plugin.info = {
        name: 'continuous-orientation-circle15',
        description: '',
        parameters: {
            set_size: {
 ...
 var mouseclickevent = function() {
    ...
    function SetMask(id, deg, myImg, trial,rotdegrees) {
       ...
       //document.getElementById(id).style.backgroundSize = 'contain';
        ...
        //var myImg = 'img/mask.png'
        var myImg2 = 'img/mask6.png'
        //////SOMEONE ELSES
       // function bg() {

            var imgCount = 3;
        var randomCount = (Math.floor(Math.random() * imgCount));
        var images = ['img/mask.png', 'img/mask6.png', 'img/mask7.png'];
        //document.getElementById(id).setAttribute("style", `url('${myImg.toString()}')`);
        // }
         // Don't forget to run the function instead of just defining it.
         //bg();
         document.getElementById(id).style.background += `url('${myImg2.toString()}')`;

         var box23 = document.getElementById(id);
        box23.style.background= "url(" + 'img/mask3.png' + ") center left 48px no-repeat, \
        url('img/mask.png') center right 10px no-repeat, \
        url('img/mask2.png') center right 10px no-repeat, \
                        rgb(200, 80, 50)";
        box23.style.backgroundSize="48px, contain";

        document.getElementById(id).style.background = "url('img/mask3.png') no-repeat right top";
        document.getElementById(id).style.background += "#f3f3f3 url('img/mask.png') no-repeat left top";
        document.getElementById(id).style.background += `url('${myImg.toString()}')`;
      //  document.getElementById(id).style.background = "url(http://goo.gl/PLN74m) left top/50% no-repeat, url(http://goo.gl/30JKDs) right top/50% no-repeat";
      //   document.getElementById(id).style.backgroundImage = "url(img/mask6.png) left top/50% no-repeat, url(img/mask7.png) right top/50% no-repeat";
         

//////FIRST ONE
       // document.getElementById(id).src = "img/mask6.png";
       //document.getElementById(id).addClass('multi_bg_example');
    ...
    function SetMask2(id, deg, myImg, trial,rotdegrees) {
        deg=(deg>=360) ? deg-360:deg;
        deg=(deg<0) ? deg+360:deg;
        var amt = rotdegrees;
        var width = 100;  //var width = trial.radius * 2 + trial.item_size * 2 + 50;
       ...
       //document.getElementById(id).style.backgroundSize = 'contain';
        //var myImg = gaborgen(rotdegrees, 100) //UNCOMMENT FOR REAL ONE
        var myImg = 'img/mask.png'
        var myImg2 = 'img/mask7.png'
      
       
                //////SECOND ONE
                document.getElementById(id).style.backgroundRepeat = "no-repeat"
                document.getElementById(id).style.backgroundSize = "90px"
                document.getElementById(id).style.backgroundPosition = "40px 90px";
                document.getElementById(id).style.backgroundImage += `url('${myImg2.toString()}')`; //UNCOMENT FOR REAL ONE
                document.getElementById(id).style.borderRadius = 80;//80; 
