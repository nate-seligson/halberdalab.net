...
var arrmax, arrmin, deg2rad, gabMask, meshgrid, pi, rescale, rescale_core;

gabMask = function(tilt, sf) {
  ...
  if ((tilt > 100 || tilt < 1) || (sf > 100 || sf < 1)) {
    console.log("ERROR: gabMask arguenment input out of bounds");
  }
  reso = 400;
  phase = 0;
  sc = 50.0;
  ...
  out = numeric.imageURL([scaledM, scaledM, scaledM]);
